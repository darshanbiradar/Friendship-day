...
export default function FinalMessageScreen() {
  ...
  const messages = [
    "Hey bestie! 💕",
    "You mean the world to me... uk it dumbo",
    "Through every laugh, every tear, every crazy adventure...",
    "Ik the last month has been better for the both of us.... ",
    "You've been my constant, my support, my partner in crime(its debatble)! 🎉",
    ...
    "Well lets be together like the old days.... please..",
    "Happy Friendship Day, my dear bestfriend! 💖",
  ]
